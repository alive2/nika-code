...
const funWorkingMessages = [
	// One Piece
	localize('chat.working.fun.onepiece.1', "Hunting the One Piece of dead code"),
	localize('chat.working.fun.onepiece.2', "Sending Zoro to find the entry point"),
	localize('chat.working.fun.onepiece.3', "Gomu gomu no... typecheck!"),
	localize('chat.working.fun.onepiece.4', "Asking Nami how much these tokens cost"),
	localize('chat.working.fun.onepiece.5', "Franky is SUUUUPER compiling this"),
	localize('chat.working.fun.onepiece.6', "Brook is humming Binks' Sake while the build runs"),
	localize('chat.working.fun.onepiece.7', "Chopper is patching the bugs with cotton candy"),
	localize('chat.working.fun.onepiece.8', "Usopp says the build passes in five minutes"),
	localize('chat.working.fun.onepiece.9', "Drowning in the stack overflow like a Devil Fruit user"),
	localize('chat.working.fun.onepiece.10', "Sailing the Grand Line of node_modules"),
	localize('chat.working.fun.onepiece.11', "Sanji is cooking up a hotfix"),
	localize('chat.working.fun.onepiece.12', "Zoro took a wrong turn and is editing the wrong file"),
	localize('chat.working.fun.onepiece.13', "Jinbe is steering this PR through the review seas"),
	localize('chat.working.fun.onepiece.14', "Impel Down has nothing on this dependency hell"),
	localize('chat.working.fun.onepiece.15', "Even Roger would fear this legacy code"),
	localize('chat.working.fun.onepiece.16', "Katakuri foresaw this — a compile error"),
	localize('chat.working.fun.onepiece.17', "Wano's borders opened, but this dependency is closed-source"),
	localize('chat.working.fun.onepiece.18', "The Going Merry can't sail through these merge conflicts"),
	localize('chat.working.fun.onepiece.19', "Law's ROOM can't fix this scope creep"),
	localize('chat.working.fun.onepiece.20', "Emptied a barrel of sake for the failed build"),
	localize('chat.working.fun.onepiece.21', "Luffy stretched the deadline again"),
	localize('chat.working.fun.onepiece.22', "Shanks stopped by for a code review"),
	localize('chat.working.fun.onepiece.23', "Buggy's nose isn't the only thing splitting the codebase"),
	localize('chat.working.fun.onepiece.24', "Whitebeard is holding back the tsunami of errors"),
	localize('chat.working.fun.onepiece.25', "The Straw Hats are searching for the missing semicolon"),
	localize('chat.working.fun.onepiece.26', "Nico Robin is deciphering the ancient API docs"),
	localize('chat.working.fun.onepiece.27', "This commit is not a pirate treasure — it's a bug fix"),
	localize('chat.working.fun.onepiece.28', "Queen is testing the virus... of tech debt"),
	localize('chat.working.fun.onepiece.29', "Big Mom is hungry for more features"),
	localize('chat.working.fun.onepiece.30', "Kaido knocked the build down, but it's getting back up"),
	localize('chat.working.fun.onepiece.31', "Smoker is chasing down the leaking session"),
	localize('chat.working.fun.onepiece.32', "Trafalgar Law transplanted this function into the right file"),
	localize('chat.working.fun.onepiece.33', "Garp is fist-fighting the flaky tests"),
	localize('chat.working.fun.onepiece.34', "Mihawk is cutting through the boilerplate"),
	localize('chat.working.fun.onepiece.35', "Ace would have burned this merge conflict to ashes"),
	localize('chat.working.fun.onepiece.36', "The Thousand Sunny is weathering the CI storm"),
	localize('chat.working.fun.onepiece.37', "Davy Back Fight for the best variable names"),
	localize('chat.working.fun.onepiece.38', "Sogeking is shooting down the bugs from afar"),
	localize('chat.working.fun.onepiece.39', "Chopper's rumble ball gives the linter a second wind"),
	localize('chat.working.fun.onepiece.40', "Brook has already seen this error 47 years ago"),
	localize('chat.working.fun.onepiece.41', "Robin opened a dark passage through the type definitions"),
	localize('chat.working.fun.onepiece.42', "Zunesha is walking over the stack traces"),
	localize('chat.working.fun.onepiece.43', "Zoro trained so hard he found the bug by accident"),
	localize('chat.working.fun.onepiece.44', "Pell survived the explosion of build errors"),
	localize('chat.working.fun.onepiece.45', "Luffy declared the refactor is the One Piece"),
	localize('chat.working.fun.onepiece.46', "Nami is mapping out the route to production"),
	localize('chat.working.fun.onepiece.47', "Franky built a cola-powered CI pipeline"),
	localize('chat.working.fun.onepiece.48', "The Going Merry is getting patched in the shipyard of hotfixes"),
	localize('chat.working.fun.onepiece.49', "Enies Lobby's gates of justice can't stop this PR"),
	localize('chat.working.fun.onepiece.50', "The Marines are chasing this unhandled exception"),
	localize('chat.working.fun.onepiece.51', "Crocus is prescribing a hotfix for the Grand Line headache"),
	localize('chat.working.fun.onepiece.52', "Laboon is waiting for this build to finish"),
	localize('chat.working.fun.onepiece.53', "Loguetown is where it began — and where the build failed again"),
	localize('chat.working.fun.onepiece.54', "Sabo ate the flame fruit and burned the TODO comments"),
	localize('chat.working.fun.onepiece.55', "Carrot jumped on the merge request"),
	localize('chat.working.fun.onepiece.56', "Yamato is defending the codebase from bad refactors"),
	localize('chat.working.fun.onepiece.57', "Kin'emon is explaining the plan, but nobody gets the costume"),
	localize('chat.working.fun.onepiece.58', "Usopp ran from the test failures — they were too scary"),
	localize('chat.working.fun.onepiece.59', "Foxy's slow-slow beam is slowing down the CI pipeline"),
	localize('chat.working.fun.onepiece.60', "Iceburg is drafting the blueprints for this refactor"),

	// Nika (the Sun God)
	localize('chat.working.fun.nika.1', "The drums of liberation are beating — the build is green"),
	localize('chat.working.fun.nika.2', "Laughing like Nika at the merge conflict"),
	localize('chat.working.fun.nika.3', "Sun God Nika is illuminating the stack trace"),
	localize('chat.working.fun.nika.4', "The Will of D. — for Delete"),
	localize('chat.working.fun.nika.5', "Knocking out lint errors with Conqueror's Haki"),
	localize('chat.working.fun.nika.6', "Gear 5: unlimited compile attempts"),
	localize('chat.working.fun.nika.7', "Joy Boy is decoding the ancient poneglyph of tech debt"),
	localize('chat.working.fun.nika.8', "The liberation drumbeat syncs with the build progress"),
	localize('chat.working.fun.nika.9', "Gomu gomu no... rocket commit!"),
	localize('chat.working.fun.nika.10', "Nika's hair turned white — the rebase got messy"),
	localize('chat.working.fun.nika.11', "Counting tokens like Nami counts beri"),
	localize('chat.working.fun.nika.12', "Sun God Nika has awakened — the linter has calmed down"),
	localize('chat.working.fun.nika.13', "Nika laughs — the 500 error flees in fear"),
	localize('chat.working.fun.nika.14', "Sun God mode: deprecation warnings fear this one"),
	localize('chat.working.fun.nika.15', "The One Piece of clean code is real — found it in git log"),
	localize('chat.working.fun.nika.16', "Nika stretched through the monorepo like rubber"),
	localize('chat.working.fun.nika.17', "The drum of liberation plays when the build turns green"),
	localize('chat.working.fun.nika.18', "Nika's smile is the only thing bigger than this refactor"),
	localize('chat.working.fun.nika.19', "Gomu gomu no... bug hunt!"),
	localize('chat.working.fun.nika.20', "Sun God's Haki knocked out the flaky tests"),
	localize('chat.working.fun.nika.21', "Nika turned the deadline into rubber and stretched it"),
	localize('chat.working.fun.nika.22', "The liberation of this codebase from its legacy shackles"),
	localize('chat.working.fun.nika.23', "Nika's white hair means the typecheck is serious business"),
	localize('chat.working.fun.nika.24', "Gear 5: the compiler can't keep up"),
	localize('chat.working.fun.nika.25', "Joy Boy's promise: the build will pass one day"),
	localize('chat.working.fun.nika.26', "Sun God mode: even the linter is smiling"),
	localize('chat.working.fun.nika.27', "The drums echo — deploy on Friday"),
	localize('chat.working.fun.nika.28', "Nika's heartbeat syncs with the npm install progress"),
	localize('chat.working.fun.nika.29', "The Will of D. — for Deployment"),
	localize('chat.working.fun.nika.30', "Sun God Nika rewinds the broken commit"),
	localize('chat.working.fun.nika.31', "Nika rubber-armed the remote and pulled the latest"),
	localize('chat.working.fun.nika.32', "Gear 5 makes the impossible refactor possible"),
	localize('chat.working.fun.nika.33', "Nika's laughter is the sound of tests passing"),
	localize('chat.working.fun.nika.34', "Nika high-fives the CI pipeline"),
	localize('chat.working.fun.nika.35', "Joy Boy's treasure: a clean git history"),
	localize('chat.working.fun.nika.36', "Nika bounces back from every stack trace"),
	localize('chat.working.fun.nika.37', "The sun god's warmth melts the frozen dependencies"),
	localize('chat.working.fun.nika.38', "Gomu gomu no... ship it!"),
	localize('chat.working.fun.nika.39', "Nika turns the red build into joy"),
	localize('chat.working.fun.nika.40', "The drums of liberation: PR merged"),
	localize('chat.working.fun.nika.41', "Nika is playing drums on the keyboard"),
	localize('chat.working.fun.nika.42', "Sun God mode: zero errors, all smiles"),
	localize('chat.working.fun.nika.43', "Nika rubber-banded the scope back into shape"),
];
